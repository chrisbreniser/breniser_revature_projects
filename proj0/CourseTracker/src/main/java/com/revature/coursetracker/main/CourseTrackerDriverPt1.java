...
public class CourseTrackerDriverPt1 {
	...
	private static boolean setTeacher() {
		...
		// get teacher info from system.in
	...
	private static boolean addAssignment() {
		...
		System.out.println("What is the assignment decription?");
		...
		Assignment assignment = new Assignment(title, description, startDate, dueDate);
